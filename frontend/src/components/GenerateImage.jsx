...
const generateImageAPI = async (prompt) => {
  const res = await axios.post("https://ai-text-to-image-generation-mern.onrender.com/generate-image", {
    prompt,
  });
...
const GenerateImage = () => {
  ...
  const handleGenerateImage = () => {
    ...
    if (mutation?.data?.message === '400 Billing hard limit has been reached') {
      alert('Billing hard limit has been reached. Please upgrade your plan to continue generating images.');
    }
